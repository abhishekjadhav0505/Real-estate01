    ...
    viewport={{once:true}}className='text-center p-6 py-20 lg:px-32 w-full overflow-hidden' id='Contact'>
        ...
        <form  className='max-w-2xl mx-auto text-gray-600 pt-8'>
            <div className='flex flex-wrap'>
                ...
                Your Name
                <input className='w-full border border-gray-300 rounded py-3 px-4 mt-2' type="text" placeholder='Name' required/>
                </div>
            ...
            <div className='my-6 text-left'>
                Message
                <textarea className='w-full border border-gray-300 rounded py-3 px-4 mt-2 h-48 ' name="Message" id="Message" required></textarea>
            </div>
        </form>
