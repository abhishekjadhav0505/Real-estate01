...
const Testimonials = () => {
  return (
    ...
    viewport={{once:true}}className='container mx-auto py-0 lg:px-32 w-full overflow-hidden ' id='Testimonials'>
        <h1 className='text-2xl sm:text-4xl font-bold mb-2 text-center '>Customer <span className='font-light '>Testimonials</span></h1>
        <p className='text-center mb-12 max-w-80 mx-auto'>Real Stories from Those Who Found Home with Us</p>
            ...
            {testimonialsData.map((testimonials,index)=>(
                <div key={index} className='max-w-[340px] border border-gray-300 shadow-lg rounded px-8 py-12 text-center'>
                    ...
                    <div className='flex justify-center gap-1 text-red-500 mb-4'>
                        {Array.from({length: testimonials.rating}, (index)=>(
